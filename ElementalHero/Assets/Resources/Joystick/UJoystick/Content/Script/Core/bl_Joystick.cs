...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [SerializeField, Range(0.5f, 4)] private float OnPressScale = 1.7f;//return to default position speed
    [SerializeField, Range(0.5f, 4)] private float OffPressScale = 1.5f;//return to default position speed
    ...
    private Vector3 OffPressScaleVector;
    ...
    void Start()
    {
        ...
        OffPressScaleVector = new Vector3(OffPressScale, OffPressScale, OffPressScale);
    ...
    IEnumerator ScaleJoysctick(bool increase)
    {
        float _time = 0;
            ...
            {
                v = Vector3.Lerp(StickRect.localScale, OffPressScaleVector, (_time / Duration));
            }
